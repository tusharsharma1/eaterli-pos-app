...
import {Image, PermissionsAndroid, ScrollView, TouchableOpacity, View} from 'react-native';
  ...
  return (
    ...
    <View
      style={{
        ...
        <Text align='center' mt={10} medium size={17} color='#F4F4F6'>5:30 PM</Text>
      <ScrollView
        contentContainerStyle={{
          paddingHorizontal: 10,
          paddingVertical: 10,
        }}>
        <MenuButton Icon={RMenuIcon} active text="Menu"  onPress={() => {
        ...
        <MenuButton
          ...
          text="Customers"
        />
        <MenuButton Icon={OrderIcon} text="Orders"   onPress={() => {
                navigation.navigate('Orders');
              }}/>
               <MenuButton Icon={OrderIcon} text="Hold Orders"   onPress={() => {
        ...
        />
        <MenuButton Icon={GiftCardIcon} text="Gift Cards"   onPress={() => {
                dispatch(
                  userAction.set({
        ...
        <MenuButton Icon={CheckInIcon} text="Check In/Out"  onPress={() => {
                navigation.navigate('CheckInOut');
              }} />
        <MenuButton Icon={TestingIcon} text="Testing"   onPress={() => {
        ...
        <MenuButton Icon={SaleIcon} text="Sale"  onPress={() => {
                POSModule.doOpenCashBox();
              }}/>
        <MenuButton Icon={AdjustIcon} text="Adjust Float" />
        <MenuButton Icon={AdjustIcon} text="Dining Option" onPress={() => {
                toggleModal();
              }} />
        <MenuButton Icon={AdjustIcon} text="Scan Reader"  onPress={async () => {
